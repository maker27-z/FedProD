...
class StrongTeacherMLP(nn.Module):
    def __init__(self, num_features=79, num_classes=5):  # Teacher model
        super(StrongTeacherMLP, self).__init__()
        # Feature encoder with larger dimensions
        ...
        # Fully connected layers for classification with larger dimensions
